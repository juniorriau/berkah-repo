...
elseif ($module=='satuan_barang' AND $act=='input'){ // ==============================================================================
    mysql_query("INSERT INTO satuan_barang(namaSatuanBarang)
                    VALUES('$_POST[namaSatuanBarang]')");
    header('location:media.php?module='.$module);
...
elseif ($module=='kategori_barang' AND $act=='input'){
    mysql_query("INSERT INTO kategori_barang(namaKategoriBarang,margin)
                    VALUES('$_POST[namaKategoriBarang]','$_POST[marginKategoriBarang]')");
    header('location:media.php?module='.$module);
...
elseif ($module=='kategori_barang' AND $act=='update'){
    mysql_query("UPDATE kategori_barang SET namaKategoriBarang = '$_POST[namaKategoriBarang]', margin = '$_POST[margin]'
...
elseif ($module=='barang' AND $act=='input'){
	$sql="select margin from kategori_barang where idKategoriBarang='".$_POST['kategori_barang']."'";
	$res=mysql_query($sql);
	$data=mysql_fetch_assoc($res);
	$margin=$data['margin'];
    mysql_query("INSERT INTO `barang`
	(`namaBarang`, `idKategoriBarang`, `idSatuanBarang`, `idSupplier`, `barcode`, `qtyStock`, `qtyMinimum`, `qtyMaximum`, `hargaBeli`, `hargaJual`)
	VALUES ('".$_POST['namaBarang']."','".$_POST['kategori_barang']."','".$_POST['satuan_barang']."','".$_POST['supplier']."','".$_POST['barcode']."','".$_POST['qtyStock']."','".$_POST['qtyMin']."','".$_POST['qtyMax']."','".$_POST['hargaBeli']."','".$_POST['hargaBeli']*$margin."')");
    header('location:media.php?module='.$module);
}// end Input Barang

// Update Barang
elseif ($module=='barang' AND $act=='update'){
    mysql_query("UPDATE `barang` SET `namaBarang`='".$_POST['namaBarang']."',`idKategoriBarang`='".$_POST['kategori_barang']."',`idSatuanBarang`='".$_POST['satuan_barang']."',`idSupplier`='".$_POST['supplier']."',`qtyStock`='".$_POST['qtyStock']."',`qtyMinimum`='".$_POST['qtyMin']."',`qtyMaximum`='".$_POST['qtyMax']."',`hargaBeli`='".$_POST['hargaBeli']."',`hargaJual`='".$_POST['hargaBeli']*$margin."' WHERE `barcode`='".$_POST['barcode']."'");
    header('location:media.php?module='.$module);
}// end Update Barang
//delete barang
elseif ($module=='barang' AND $act=='hapus'){
	mysql_query("DELETE FROM barang where idBarang='".$_GET['id']."'");
	header('location:media.php?module='.$module);
}
// Input Supplier     =============================================================================================================================
