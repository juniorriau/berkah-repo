...
?>	
	...
	function popupform(myform)
	{
		...
		window.open('', 'Penjualan Barang', 'type=fullWindow,fullscreen,scrollbars=yes');
		myform.target='Penjualan Barang';
		return true;
		//alert(myform+windowname);
	}
	//-->
	</SCRIPT>
...
<?php
	...
	$namaCustomer=mysql_query($sql);
        ...
        echo "<h2>Penjualan Barang</h2>
              <form method=POST action='modul/js_jual_barang.php?act=caricustomer' onSubmit=\"popupform('modul/js_jual_barang.php?act=caricustomer')\">
