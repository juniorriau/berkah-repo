...
switch($_GET[act]){ // ---------------------------------------------------------------------------------------------------------------------------
    ...
    default:
		...
		<tr>
			...
			<input type=submit value='(l) Laporan Pembelian (per Tanggal)' accesskey='l'><br /><center></center>
			</form>
                    </td>
                    <td>
			<form method=POST action='?module=pembelian_barang&act=laporanpembelian'>
			<input type=submit value='(s) Laporan Pembelian (per Supplier)' accesskey='s'><br /><center></center>
			</form>
                    </td>
                    <td>
    ...
    case "carisupplier": // ====================================================================================================================
        if(!isset($_SESSION[idSupplier])){
		if (isset($_POST[idSupplier])) {
           		findSupplier($_POST[idSupplier]);
		} else {
			findSupplier($_GET[idSupplier]);   
       		};
        }
